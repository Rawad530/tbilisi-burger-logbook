...
export const menuItems: MenuItem[] = [
  ...
  { id: '5', name: 'Beef Burger', price: 9.00, category: 'mains', requiresSauce: true },
  { id: '6', name: 'Beef Burger (Combo)', price: 15.00, category: 'mains', requiresSauce: true, isCombo: true },
  { id: '7', name: 'Double Beef Burger', price: 9.00, category: 'mains', requiresSauce: true },
  { id: '8', name: 'Double Beef Burger (Combo)', price: 15.00, category: 'mains', requiresSauce: true, isCombo: true },
  { id: '9', name: 'Chicken Wrap', price: 12.00, category: 'mains', requiresSauce: true },
  { id: '10', name: 'Chicken Wrap (Combo)', price: 18.00, category: 'mains', requiresSauce: true, isCombo: true },
  ...
  { id: '15', name: 'Double Beef Wrap', price: 12.00, category: 'mains', requiresSauce: true },
  { id: '16', name: 'Double Beef Wrap (Combo)', price: 18.00, category: 'mains', requiresSauce: true, isCombo: true },
